#!/bin/bash
wget 'http://www.quandl.com/api/v1/datasets/BITCOIN/MTGOXUSD.csv?&trim_start=2010-07-17&trim_end=2013-07-04&collapse=daily&sort_order=desc' -O data/mtgox-btc-usd.csv
