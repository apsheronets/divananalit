...
url = 'http://www.cryptocoincharts.info/period-charts.php?period=alltime&resolution=day&pair=btc-usd&market=mtgox'
...
trs.each do |tr|
  ...
  volume = tds[5].inner_text.gsub(/BTC/, '').gsub(/,/, '').strip
